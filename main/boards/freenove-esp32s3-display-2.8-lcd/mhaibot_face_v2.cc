...
void MhaiBotFaceV2::ApplyPose(const Pose& pose) {
    ...
    lv_obj_set_style_radius(right_eye_, pose.radius, 0);
    lv_obj_set_pos(left_eye_, pose.left_x, pose.y);
    lv_obj_set_pos(right_eye_, pose.right_x, pose.y);
}
